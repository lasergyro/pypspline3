...
def griddata(x1, x2, x3):
    ...
    xx2 = _np.multiply.outer(_np.ones((n3,)), _np.multiply.outer(x2, _np.ones((n1,))))
...
class pspline:
    ...
    def __init__(self, x1, x2, x3, bcs1=None, bcs2=None, bcs3=None):
        """
        Constructor.
        ...
        # BC values (see above)
        self.bcval1min = _np.zeros(
            (
                n3,
                n2,
            )
        )
        self.bcval1max = _np.zeros(
            (
                n3,
                n2,
            )
        ...
        self.bcval2min = _np.zeros(
            (
                n3,
                n1,
            )
        )
        self.bcval2max = _np.zeros(
            (
                n3,
                n1,
            )
        ...
        self.bcval3min = _np.zeros(
            (
                n2,
                n1,
            )
        )
        self.bcval3max = _np.zeros(
            (
                n2,
                n1,
            )
    ...
    def setup(self, f):
        ...
        if _np.shape(f) != (self.__n3, self.__n2, self.__n1):
            raise "pspline3_r4::setup shape error. Got shape(f)=%s should be %s" % (
                str(_np.shape(f)),
                str((self.__n3, self.__n2, self.__n1)),
            )
        ...
        self.__ilin1, self.__ilin2, self.__ilin3, ifail = fpspline.mktricub(
            self.__x1,
            self.__x2,
            self.__x3,
            self.__fspl.flat,
    ...
    def interp_cloud(self, p1, p2, p3):
        ...
        fi, iwarn, ier = fpspline.vectricub(
            ICT_FVAL,
            p1,
            p2,
            p3,
    ...
    def interp_array(self, p1, p2, p3):
        ...
        """
        fi, iwarn, ier = fpspline.gridtricub(
            p1, p2, p3, self.__x1pkg, self.__x2pkg, self.__x3pkg, self.__fspl.flat
        )
    ...
    def gradient_cloud(self, p1, p2, p3):
        ...
        f1, iwarn1, ier1 = fpspline.vectricub(
            ICT_F1,
            p1,
            p2,
            p3,
        ...
        f2, iwarn2, ier2 = fpspline.vectricub(
            ICT_F2,
            p1,
            p2,
            p3,
        ...
        f3, iwarn3, ier3 = fpspline.vectricub(
            ICT_F3,
            p1,
            p2,
            p3,
