...
class pspline:
    ...
    def __init__(self, x1, x2, bcs1=None, bcs2=None):
        """
        Constructor.
    ...
    def setup(self, f):
        ...
        self.__ilin1, self.__ilin2, ifail = fpspline.mkbicub(
            self.__x1,
            self.__x2,
            self.__fspl.flat,
            self.__ibctype1[0],
    ...
    def interp_cloud(self, p1, p2):
        ...
        fi, iwarn, ier = fpspline.vecbicub(
            ICT_FVAL, p1, p2, self.__x1pkg, self.__x2pkg, self.__fspl.flat
        )
        return fi, ier, iwarn
    ...
    def interp_array(self, p1, p2):
        ...
        fi, iwarn, ier = fpspline.gridbicub(
            p1, p2, self.__x1pkg, self.__x2pkg, self.__fspl.flat
        )
    ...
    def derivative_cloud(self, i1, i2, p1, p2):
        ...
        """
            ...
            ICT_MAP[(i1, i2)], p1, p2, self.__x1pkg, self.__x2pkg, self.__fspl.flat
        )
        return fi, ier, iwarn
    ...
    def gradient_cloud(self, p1, p2):
        ...
        f1, iwarn1, ier1 = fpspline.vecbicub(
            ICT_F1, p1, p2, self.__x1pkg, self.__x2pkg, self.__fspl.flat
        )
        f2, iwarn2, ier2 = fpspline.vecbicub(
            ICT_F2, p1, p2, self.__x1pkg, self.__x2pkg, self.__fspl.flat
        )
    ...
    def gradient_array(self, p1, p2):
        ...
        n1, n2 = len(p1), len(p2)
        return _np.resize(f1, (n2, n1)), _np.resize(f2, (n2, n1)), ier, iwarn
